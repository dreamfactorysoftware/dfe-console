 ...
 * Generated for Laravel 4.2.16 on 2015-02-02.
 *
...
namespace {
    ...
    class Elk extends \DreamFactory\Enterprise\Console\Services\ElkServiceProvider{
    ...
    class View extends \Illuminate\Support\Facades\View{
         ...
         * @param string $file
         * @param array $vars
         * @param \Radic\BladeExtensions\Directives\closure $callback
         * @return void 
         * @static 
         */
        public static function renderPartial($file, $vars, $callback){
            \Radic\BladeExtensions\Directives\PartialFactory::renderPartial($file, $vars, $callback);
        }
        ...
        public static function startBlock($block, $content = ''){
            \Radic\BladeExtensions\Directives\PartialFactory::startBlock($block, $content);
        }
        ...
        public static function stopBlock(){
            \Radic\BladeExtensions\Directives\PartialFactory::stopBlock();
        }
        ...
        public static function renderBlock($block, $default = ''){
            return \Radic\BladeExtensions\Directives\PartialFactory::renderBlock($block, $default);
        }
        ...
        public static function getBlocks(){
            return \Radic\BladeExtensions\Directives\PartialFactory::getBlocks();
        }
        ...
        public static function flushBlocks(){
            \Radic\BladeExtensions\Directives\PartialFactory::flushBlocks();
        }
        ...
        public static function make($view, $data = array(), $mergeData = array()){
            ...
            return \Radic\BladeExtensions\Directives\PartialFactory::make($view, $data, $mergeData);
        }
        ...
        public static function of($view, $data = array()){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::of($view, $data);
        }
        ...
        public static function name($view, $name){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::name($view, $name);
        }
        ...
        public static function alias($view, $alias){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::alias($view, $alias);
        }
        ...
        public static function exists($view){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::exists($view);
        }
        ...
        public static function renderEach($view, $data, $iterator, $empty = 'raw|'){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::renderEach($view, $data, $iterator, $empty);
        }
        ...
        public static function getEngineFromPath($path){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::getEngineFromPath($path);
        }
        ...
        public static function share($key, $value = null){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::share($key, $value);
        }
        ...
        public static function creator($views, $callback){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::creator($views, $callback);
        }
        ...
        public static function composers($composers){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::composers($composers);
        }
        ...
        public static function composer($views, $callback, $priority = null){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::composer($views, $callback, $priority);
        }
        ...
        public static function callComposer($view){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::callComposer($view);
        }
        ...
        public static function callCreator($view){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::callCreator($view);
        }
        ...
        public static function startSection($section, $content = ''){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::startSection($section, $content);
        }
        ...
        public static function inject($section, $content){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::inject($section, $content);
        }
        ...
        public static function yieldSection(){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::yieldSection();
        }
        ...
        public static function stopSection($overwrite = false){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::stopSection($overwrite);
        }
        ...
        public static function appendSection(){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::appendSection();
        }
        ...
        public static function yieldContent($section, $default = ''){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::yieldContent($section, $default);
        }
        ...
        public static function flushSections(){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::flushSections();
        }
        ...
        public static function flushSectionsIfDoneRendering(){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::flushSectionsIfDoneRendering();
        }
        ...
        public static function incrementRender(){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::incrementRender();
        }
        ...
        public static function decrementRender(){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::decrementRender();
        }
        ...
        public static function doneRendering(){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::doneRendering();
        }
        ...
        public static function addLocation($location){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::addLocation($location);
        }
        ...
        public static function addNamespace($namespace, $hints){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::addNamespace($namespace, $hints);
        }
        ...
        public static function prependNamespace($namespace, $hints){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::prependNamespace($namespace, $hints);
        }
        ...
        public static function addExtension($extension, $engine, $resolver = null){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::addExtension($extension, $engine, $resolver);
        }
        ...
        public static function getExtensions(){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::getExtensions();
        }
        ...
        public static function getEngineResolver(){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::getEngineResolver();
        }
        ...
        public static function getFinder(){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::getFinder();
        }
        ...
        public static function setFinder($finder){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::setFinder($finder);
        }
        ...
        public static function getDispatcher(){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::getDispatcher();
        }
        ...
        public static function setDispatcher($events){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::setDispatcher($events);
        }
        ...
        public static function getContainer(){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::getContainer();
        }
        ...
        public static function setContainer($container){
            //Method inherited from \Illuminate\View\Factory            
            \Radic\BladeExtensions\Directives\PartialFactory::setContainer($container);
        }
        ...
        public static function shared($key, $default = null){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::shared($key, $default);
        }
        ...
        public static function getShared(){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::getShared();
        }
        ...
        public static function getSections(){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::getSections();
        }
        ...
        public static function getNames(){
            //Method inherited from \Illuminate\View\Factory            
            return \Radic\BladeExtensions\Directives\PartialFactory::getNames();
        }
        
    }


    class Packet extends \DreamFactory\Library\Fabric\Api\Common\Facades\Packet{
         ...
         * @static 
         */
        public static function success($code = 200, $contents = null){
            return \DreamFactory\Library\Fabric\Api\Common\Services\PacketService::success($code, $contents);
        }
         ...
         * @static 
         */
        public static function failure($code = 404, $message = null, $contents = null){
            return \DreamFactory\Library\Fabric\Api\Common\Services\PacketService::failure($code, $message, $contents);
        }
        
        /**
         * Sets a logger instance on the object
         *
         * @param \DreamFactory\Library\Fabric\Api\Common\Services\LoggerInterface $logger
         * @return $this 
         * @static 
         */
        public static function setLogger($logger){
            //Method inherited from \DreamFactory\Library\Fabric\Api\Common\Services\BaseService            
            return \DreamFactory\Library\Fabric\Api\Common\Services\PacketService::setLogger($logger);
        }
        
        /**
         * 
         *
         * @return \DreamFactory\Library\Fabric\Api\Common\Services\LoggerInterface 
         * @static 
         */
        public static function getLogger(){
            //Method inherited from \DreamFactory\Library\Fabric\Api\Common\Services\BaseService            
            return \DreamFactory\Library\Fabric\Api\Common\Services\PacketService::getLogger();
        }
