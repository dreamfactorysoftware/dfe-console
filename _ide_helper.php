 ...
 * Generated for Laravel 5.0.18 on 2015-03-21.
 *
...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \DreamFactory\Enterprise\Console\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \DreamFactory\Enterprise\Console\Console\Kernel::terminate($input, $status);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \DreamFactory\Enterprise\Console\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \DreamFactory\Enterprise\Console\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \DreamFactory\Enterprise\Console\Console\Kernel::all();
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \DreamFactory\Enterprise\Console\Console\Kernel::output();
        }
        ...
        public static function bootstrap(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \DreamFactory\Enterprise\Console\Console\Kernel::bootstrap();
        }
    ...
    class Auth extends \Illuminate\Support\Facades\Auth{
         ...
         *
         * @return \DreamFactory\Library\Fabric\Database\Models\Deploy\ServiceUser|null 
         * @static 
         */
         ...
         * @param mixed $id
         * @param bool $remember
         * @return \DreamFactory\Library\Fabric\Database\Models\Deploy\ServiceUser 
         * @static 
         */
