...
/*Data for the table `environment_t` */

insert into `environment_t`(`id`,`user_id`,`environment_name_text`,`create_date`,`lmod_date`) values (1,NULL,'Development',NOW(),NOW()),(2,NULL,'Production',NOW(),NOW());
...
/*Data for the table `mount_t` */

insert into `mount_t`(`id`,`mount_type_nbr`,`mount_id_text`,`owner_id`,`owner_type_nbr`,`root_path_text`,`config_text`,`last_mount_date`,`create_date`,`lmod_date`) values (1,0,'mount-local-1',0,NULL,'/data/storage','{\"disk\":\"local\"}',NULL,NOW(),NOW());
...
insert into `vendor_t`(`id`,`vendor_name_text`,`create_date`,`lmod_date`) values (1,'Amazon EC2',NOW(),NOW()),(2,'DreamFactory',NOW(),NOW()),(3,'Windows Azure',NOW(),NOW()),(4,'Rackspace',NOW(),NOW()),(5,'OpenStack',NOW(),NOW());
