...
(function($, window, document, undefined) {
	...
	$.fn.multientry = function(options) {
		...
		return this.each(function() {
			...
			$('<div class="' + options.innerDivClass + '"><div class="span5" style="margin-left: 0;"><div style="margin-bottom: 0;" class="well"><ul class="nav nav-list ' + options.ulClass + '" id="' + options.attribute + '" style="min-height:' + options.minimumHeight + ';"></ul></div></div></div>').appendTo($_pif);

			//	Input element (control-group)
			$('<div class="' + options.divClass + '"><div class="' + options.innerDivClass + '"><div class="input-append"><input data-parent="ul#' + options.attribute + '" id="df-multientry-add-item-' + options.attribute + '" class="span5 ' + options.inputClass + '" type="text" placeholder="' + options.placeholder + '" style = "margin-right:4px"><button class="' + options.buttonClass + '">Add</button></div><hr class="df-multientry-divider" style="margin:18px 0 0;" /></div></div>').appendTo($_me);
