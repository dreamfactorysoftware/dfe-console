		...
		return this.each(function() {
			...
			if ( oAddNewRowForm.length != 0 ) {
				...
				if ( oConfirmRowAddingButton.length == 0 ) {
					...
					if ( properties.oAddNewRowOkButtonOptions.text == null || properties.oAddNewRowOkButtonOptions.text == "" ) {
				...
				if ( oCancelRowAddingButton.length == 0 ) {
					...
					if ( properties.oAddNewRowCancelButtonOptions.text == null || properties.oAddNewRowCancelButtonOptions.text == "" ) {
			...
			if ( oAddDeleteToolbar.length != 0 ) {
				if ( oAddNewRowButton == null && properties.sAddNewRowButtonId != "" && oAddNewRowForm != null ) {
