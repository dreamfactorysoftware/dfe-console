                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Name</label>
                                <input id="instance_name_text" class="form-control"
                                       placeholder="Enter instance name." type="text">
                            </div>
                            <div class="form-group">
                                <label for="instance_cluster_select">Cluster</label>
                            ...
                            <div class="form-group">
                                <label for="instance_policy_select">Policy</label>
                            ...
                            <div class="form-group">
                                <label for="instance_ownername_text">Owner</label>
                                <input id="instance_ownername_text" class="form-control"
                                       value="{{ Auth::user()->email_addr_text }}" type="text" disabled>
                            </div>
