    ...
    <div class="col-xs-11 col-sm-10 col-md-10">
        ...
        <form class="form-horizontal instance-form" method="POST" action="/{{$prefix}}/instances">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="owner_email">Instance Owner</label>
                <div class="col-md-6">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="cluster_id">Provisioning Cluster</label>
                <div class="col-md-6">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="instance_name_text">Instance Name</label>
                <div class="col-md-6">
                    <input id="instance_name_text" name="instance_name_text" class="form-control" placeholder="Instance Name" type="text" required>
