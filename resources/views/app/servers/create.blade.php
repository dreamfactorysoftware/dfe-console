                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>Name</label>
                                <input id="server_id_text" name="server_id_text" class="form-control"
                                       placeholder="Enter server name." type="name"
                                       value="{{ Input::old('server_id_text') }}">
                            </div>
                            <div class="form-group">
                                <label>Host</label>
                                <input id="host_text" name="host_text" class="form-control" placeholder="Enter host."
                                       type="text" value="{{ Input::old('host_text') }}">
                            </div>
                            <div class="form-group">
                                <label>Type</label>
                                <select class="form-control" id="server_type_select" name="server_type_select">
                                    ...
                                    @foreach ($server_types as $server_type)
                                        <option id="{{$server_type['id']}}"
                                                @if (Input::old('server_type_select') == $server_type['type_name_text']) selected="selected" @endif>{{$server_type['type_name_text']}}</option>
                                    @endforeach
                                </select>
                            </div>
