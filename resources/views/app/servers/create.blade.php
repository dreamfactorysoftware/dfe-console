                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Name</label>
                                                            <input id="server_name_text" class="form-control" placeholder="Enter server name." type="name">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Type</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label>Host</label>
                                                            <input id="server_host_text" class="form-control" placeholder="Enter host." type="text">
                                                        </div>
                                                        ...
                                                        <div id="server_type_db" style="display: none;">
                                                            <div class="form-group">
                                                                <label>Port</label>
                                                                <input id="db_port_text" class="form-control" placeholder="Enter port." type="text">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>User Name</label>
                                                                <input id="db_username_text" class="form-control" placeholder="Enter user name." type="text">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Password</label>
                                                                <input id="db_password_text" class="form-control" placeholder="Enter password." type="password">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Default Database Name</label>
                                                                <input id="db_default_db_name_text" class="form-control" placeholder="Enter default database name." type="text">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div id="server_type_web" style="display: none;">
                                                            <div class="form-group">
                                                                <label>Port</label>
                                                                <input id="web_port_text" class="form-control" placeholder="Enter port." type="text">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Scheme</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>User Name</label>
                                                                <input id="web_username_text" class="form-control" placeholder="Enter user name." type="text">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Password</label>
                                                                <input id="web_password_text" class="form-control" placeholder="Enter password." type="password">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div id="server_type_app" style="display: none;">
                                                            <div class="form-group">
                                                                <label>Port</label>
                                                                <input id="app_port_text" class="form-control" placeholder="Enter port." type="text">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Scheme</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>User Name</label>
                                                                <input id="app_username_text" class="form-control" placeholder="Enter user name." type="text">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Password</label>
                                                                <input id="app_password_text" class="form-control" placeholder="Enter password." type="password">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Access Token</label>
                                                                <input id="app_accesstoken_text" class="form-control" placeholder="Enter access token." type="password">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-xs-12">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="">
                                                                ...
                                                                <button type="button" class="btn btn-primary" onclick="saveCreateServer();">
                                                                    Create
                                                                </button>
                                                                &nbsp;&nbsp;
