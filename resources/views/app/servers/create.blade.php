                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div id="server_type_db" style="display: none;">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input id="db_default_db_name_text" name="config[db][default-database-name]" class="form-control" placeholder="Enter default database name." value="{{ Input::old('config.db.default-database-name') }}" type="text">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Server Assignment</label><br>
                                                                <input id="db_multi_asgn_text" type="checkbox" id="db_multi_asgn_text" name="config[db][multi-assign]" @if (Input::old('config.db.multi-assign') == 'on') checked @endif>
                                                    ...
                                                    <div id="server_type_app" style="display: none;">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input id="app_accesstoken_text" name="config[app][access_token]" class="form-control" placeholder="Enter access token." value="{{ Input::old('config.app.access_token') }}" type="password">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
