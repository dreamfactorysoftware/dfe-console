                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input id="email_addr_text" name="email_addr_text" class="form-control"
                                   placeholder="Enter email address." type="email"
                                   value="{{ Input::old('email_addr_text') }}">
                        </div>
                        <div class="form-group">
                            <label>First Name</label>
                            <input id="first_name_text" name="first_name_text" class="form-control"
                                   placeholder="Enter first name." type="text"
                                   value="{{ Input::old('first_name_text') }}">
                        </div>
                        <div class="form-group">
                            <label>Last Name</label>
                            <input id="last_name_text" name="last_name_text" class="form-control"
                                   placeholder="Enter last name." type="text"
                                   value="{{ Input::old('last_name_text') }}">
                        </div>
                        <div class="form-group">
                            <label>Display Name</label>
                            <input id="nickname_text" name="nickname_text" class="form-control"
                        ...
                        <div class="form-group">
                            <div id="">
                                ...
                                <span>&nbsp;</span>
                                <input id="retype_new_password" class="form-control" placeholder="Re-enter password."
                                       type="password">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="checkbox">
                                <label>
                                    <input id="active" name="active" value="1" type="checkbox" checked>
                                    Active
                                </label>
                            </div>
                        </div>
