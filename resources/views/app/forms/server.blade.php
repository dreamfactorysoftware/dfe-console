...
@section('content')
    <div role="tabpanel">
        ...
        <form class="form-horizontal" action="/api/v1/servers" method="POST">
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="profile">
                    <div class="form-group">
                        <label for="server_name_text" class="col-md-2 control-label">Name</label>
                        <div class="col-md-3">
                            <input type="text" class="form-control" id="server_name_text">
                        </div>
                    </div>
