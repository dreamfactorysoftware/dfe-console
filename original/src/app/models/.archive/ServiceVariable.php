<?php
/**
 * This is the model class for table "service_variable_t".
 *
 * @property integer  $id
 ...
 */
class ServiceVariable extends \DreamFactory\Yii\Models\BaseModel
{
	/**
	...
	{
		return array(
			array( 'service_id, name_text', 'required' ),
