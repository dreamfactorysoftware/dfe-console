...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'auth.client'     => 'DreamFactory\Enterprise\Console\Http\Middleware\AuthenticateOpsClient',
        ...
        'dfe.api-logging' => 'DreamFactory\Enterprise\Common\Http\Middleware\ApiLogger',
    ];
}
