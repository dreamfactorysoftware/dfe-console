...
?>
<div class="row">
    <?php echo $this->_renderTrail( array('Dashboard' => false), false ); ?>
</div>
...
<div class="scrollable-content">
    <div id="dashboard-header" class="row">
        ...
        <div class="col-md-2">
            <div class="dashboard-header-info"><?php echo $_active['instances']; ?>
                <span>active instances</span>
            </div>
        </div>
        <div class="col-md-2">
            <div class="dashboard-header-info">
                <?php echo $_active['clusters']; ?>
                <span>active clusters</span>
            </div>
        </div>
        <div class="col-md-2">
            <div class="dashboard-header-info">
                <?php echo $_active['users']; ?>
